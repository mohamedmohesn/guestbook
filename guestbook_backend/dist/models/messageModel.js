...
exports.Messagebook = void 0;
var database_1 = __importDefault(require("../database"));
var Messagebook = /** @class */ (function () {
    function Messagebook() {
    }
    Messagebook.prototype.index = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        conn.release();
                        if (!result.rows[0]) {
                            return [2 /*return*/, "Could not find Message"];
                        }
                        else {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not get Message. Error: ".concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        sql2 = 'SELECT id FROM guests WHERE id=($1)';
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 2:
                        conn_1 = _a.sent();
                        return [4 /*yield*/, conn_1.query(sql2, [message.guests_id])];
                    case 3:
                        result2 = _a.sent();
                        conn_1.release();
                        if (!result2.rows[0]) {
                            return [2 /*return*/, "Could not find user ".concat(message.guests_id)];
                        }
                        return [3 /*break*/, 5];
                    case 4:
                        error_1 = _a.sent();
                        throw new Error("Could not find user ".concat(message.guests_id, ". Error: ").concat(error_1));
                    case 5:
                        sql = 'INSERT INTO messages (guests_id, messagetext) VALUES($1, $2) RETURNING *';
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 6:
                        conn = _a.sent();
                        return [4 /*yield*/, conn
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'DELETE FROM messages WHERE id=($1) RETURNING *';
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [id])];
                    case 2:
                        ...
                        conn.release();
                        if (!messages) {
                            return [2 /*return*/, "Could not delete messages ".concat(id)];
                        }
                        else {
                            return [2 /*return*/, messages];
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'UPDATE messages SET messagetext=($1) WHERE id=($2) RETURNING *';
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [text, id])];
                    case 2:
                        result = _a.sent();
                        messages = result.rows[0];
                        conn.release();
                        if (!messages) {
                            return [2 /*return*/, "Could not edit messages ".concat(id)];
                        }
                        else {
                            return [2 /*return*/, messages];
                        }
...
exports.Messagebook = Messagebook;
