...
var Guestbook = /** @class */ (function () {
    ...
    Guestbook.prototype.index = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT id,email,fullname,phone FROM guests';
                    ...
                    case 2:
                        ...
                        console.log('get');
                        if (!result.rows[0]) {
                            return [2 /*return*/, "Could not find User"];
                        }
                        else {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Could not get User. Error: ".concat(error_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        hash = bcrypt_1["default"].hashSync(guest.password + pepper, Number(saltRounds));
                        return [4 /*yield*/, conn
